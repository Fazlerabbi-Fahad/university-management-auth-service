...
const updateAdmin = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_model_1.Admin.findOneAndUpdate({ _id: id }, updatedStudentData, {
        new: true,
    })
        .populate('academicFaculty')
        .populate('academicDepartment')
...
const deleteAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const student = yield admin_model_1.Admin.findOneAndDelete({ id: id }, { session });
        if (!student) {
